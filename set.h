...
public:
    ...
    private:
        ...
        typename TSparseArray<ElementType>::FBaseIterator ElementIt;

    public:
        FORCEINLINE FBaseIterator(const TSet<SetType>& InSet,typename TSparseArray<TSetElement<SetType>>::FBaseIterator InElementIt)
