...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass NachoBucket.NachoBucket_C
	 * Size -> 0x0038 (FullSize[0x0738] - InheritedSize[0x0700])
	 */
	class ANachoBucket_C : public AIGHealthAndStaminaConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_E44CDA824701EAA9B90F4281A6B461B7; // 0x0710(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_E44CDA824701EAA9B90F4281A6B461B7; // 0x0714(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_E44CDA824701EAA9B90F4281A6B461B7; // 0x0718(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_DQCT[0x7];                                   // 0x0719(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_NachoBucket(int32_t EntryPoint);
