...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass PottedPlantWeapon.PottedPlantWeapon_C
	 * Size -> 0x0008 (FullSize[0x0780] - InheritedSize[0x0778])
	 */
	class APottedPlantWeapon_C : public ABP_WeaponBase_Parent_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_PottedPlantWeapon(int32_t EntryPoint);
