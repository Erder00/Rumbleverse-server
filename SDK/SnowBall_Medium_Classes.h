...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SnowBall_Medium.SnowBall_Medium_C
	 * Size -> 0x0008 (FullSize[0x0780] - InheritedSize[0x0778])
	 */
	class ASnowBall_Medium_C : public ABP_WeaponBase_Parent_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_SnowBall_Medium(int32_t EntryPoint);
