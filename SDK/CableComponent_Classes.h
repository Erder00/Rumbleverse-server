...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IYX8[0x8];                                   // 0x0488(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_7W03[0x3];                                   // 0x04E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumSides;                                                // 0x04FC(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_JEIE[0x1C];                                  // 0x0504(0x001C) MISSED OFFSET (PADDING)
