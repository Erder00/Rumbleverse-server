...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_TeamLeaderLocation.EQC_TeamLeaderLocation_C.ProvideSingleLocation
	 */
	struct UEQC_TeamLeaderLocation_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_G2OP[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
