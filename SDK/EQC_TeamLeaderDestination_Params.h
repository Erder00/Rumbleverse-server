...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_TeamLeaderDestination.EQC_TeamLeaderDestination_C.ProvideSingleLocation
	 */
	struct UEQC_TeamLeaderDestination_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_VWIB[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
