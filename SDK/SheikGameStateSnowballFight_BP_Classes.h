...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SheikGameStateSnowballFight_BP.SheikGameStateSnowballFight_BP_C
	 * Size -> 0x0008 (FullSize[0x0788] - InheritedSize[0x0780])
	 */
	class ASheikGameStateSnowballFight_BP_C : public ASheikGameStateBR
	{
	public:
