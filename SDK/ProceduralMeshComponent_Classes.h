...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_B82R[0x8];                                   // 0x0488(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_CYU1[0x6];                                   // 0x0492(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IMF2[0x4];                                   // 0x04DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
