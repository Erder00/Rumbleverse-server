...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_CombatNotification_SuperstarActivated.WBP_CombatNotification_SuperstarActivated_C
	 * Size -> 0x0030 (FullSize[0x0448] - InheritedSize[0x0418])
	 */
	class UWBP_CombatNotification_SuperstarActivated_C : public UIGUI_WidgetBase
	{
	public:
		...
		class UImage*                                              Image_67;                                                // 0x0440(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void ShiftUp();
		void ShowSuperstarActivatedNotif();
		void ConstructOnlyOnce();
		void ExecuteUbergraph_WBP_CombatNotification_SuperstarActivated(int32_t EntryPoint);
