...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass EnergyDrinkOverTimeLongBig.EnergyDrinkOverTimeLongBig_C
	 * Size -> 0x0038 (FullSize[0x0738] - InheritedSize[0x0700])
	 */
	class AEnergyDrinkOverTimeLongBig_C : public AIGHealthAndStaminaConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_AEFBCFF445006FBA4AE5C1B750F369A7; // 0x0710(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_AEFBCFF445006FBA4AE5C1B750F369A7; // 0x0714(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_AEFBCFF445006FBA4AE5C1B750F369A7; // 0x0718(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_SXYC[0x7];                                   // 0x0719(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void BounceSFX(const struct FVector& A, class USoundCue* Sound);
		...
		void ExecuteUbergraph_EnergyDrinkOverTimeLongBig(int32_t EntryPoint);
