...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass WeightsLegsBig.WeightsLegsBig_C
	 * Size -> 0x0040 (FullSize[0x0700] - InheritedSize[0x06C0])
	 */
	class AWeightsLegsBig_C : public ASheikCoreStatsConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_1F685982486B26072CC71CAD266BCF3A; // 0x06D8(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_1F685982486B26072CC71CAD266BCF3A; // 0x06DC(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_1F685982486B26072CC71CAD266BCF3A; // 0x06E0(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_72JV[0x7];                                   // 0x06E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_WeightsLegsBig(int32_t EntryPoint);
