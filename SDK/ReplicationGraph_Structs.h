...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_R07Z[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N1HA[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		bool                                                       bIgnoreSkipActorOnCull;                                  // 0x0012(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_AFRF[0x55];                                  // 0x0013(0x0055) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
