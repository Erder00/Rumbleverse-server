...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Magazine_Rare.Magazine_Rare_C
	 * Size -> 0x0038 (FullSize[0x06F8] - InheritedSize[0x06C0])
	 */
	class AMagazine_Rare_C : public ASheikSpecialMoveConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_1A8344594783EF9F1A34EAB7051F0880; // 0x06D0(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_1A8344594783EF9F1A34EAB7051F0880; // 0x06D4(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_1A8344594783EF9F1A34EAB7051F0880; // 0x06D8(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ROYC[0x7];                                   // 0x06D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Magazine_Rare(int32_t EntryPoint);
