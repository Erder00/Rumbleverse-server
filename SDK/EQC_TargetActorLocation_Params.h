...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_TargetActorLocation.EQC_TargetActorLocation_C.ProvideSingleLocation
	 */
	struct UEQC_TargetActorLocation_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_OZ6Y[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
