...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Enum OnlineSubsystem.EKWSPermissionStatus
	 */
	enum class EKWSPermissionStatus : uint8_t
	{
		Granted  = 0,
		Rejected = 1,
		Pending  = 2,
	...
	/**
	 * Enum OnlineSubsystem.EReportReason
	 */
	enum class EReportReason : uint8_t
	{
		None                        = 0,
		Harassment                  = 1,
		Cheating                    = 2,
		HateSpeechOffensiveLanguage = 3,
		PrivacyViolation            = 4,
		Teaming                     = 5,
		GriefingAFK                 = 6,
		MAX                         = 7
	...
	public:
		...
		unsigned char                                              UnknownData_R7H4[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_BMAN[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
