...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_Sheik_LargeFormatMatchmakingInfo.WBP_Sheik_LargeFormatMatchmakingInfo_C
	 * Size -> 0x01A1 (FullSize[0x05B9] - InheritedSize[0x0418])
	 */
	class UWBP_Sheik_LargeFormatMatchmakingInfo_C : public UIGUI_WidgetBase
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0418(0x0008) ZeroConstructor, Transient, DuplicateTransient
		class UTextBlock*                                          MatchModeText;                                           // 0x0420(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UWBP_Sheik_ButtonAction_C*                           Prompt_CancelMatchmaking;                                // 0x0428(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_CS9F[0x4];                                   // 0x054C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       ShowCancelPrompt;                                        // 0x05B8(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
	...
	public:
		...
		void HandleHoldActionCancelled();
		void HandleCancelActionConfirmed();
		...
		void ExecuteUbergraph_WBP_Sheik_LargeFormatMatchmakingInfo(int32_t EntryPoint);
