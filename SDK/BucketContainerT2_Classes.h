...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BucketContainerT2.BucketContainerT2_C
	 * Size -> 0x0008 (FullSize[0x0808] - InheritedSize[0x0800])
	 */
	class ABucketContainerT2_C : public ABP_IGWeaponContainer_Parent_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BucketContainerT2(int32_t EntryPoint);
