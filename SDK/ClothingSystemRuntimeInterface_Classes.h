...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_G4V7[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_25XA[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1UXK[0x50];                                  // 0x0090(0x0050) MISSED OFFSET (PADDING)
