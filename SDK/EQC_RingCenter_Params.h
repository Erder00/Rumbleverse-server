...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_RingCenter.EQC_RingCenter_C.ProvideSingleLocation
	 */
	struct UEQC_RingCenter_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_3L7I[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
