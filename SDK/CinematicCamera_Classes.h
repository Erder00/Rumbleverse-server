...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XG2E[0x2];                                   // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_G0KO[0x3];                                   // 0x0225(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_RC2X[0x10];                                  // 0x0850(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		struct FCameraLensSettings                                 LensSettings;                                            // 0x0848(0x0018) Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_EIZU[0xC];                                   // 0x08C4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5QYR[0x8];                                   // 0x0928(0x0008) MISSED OFFSET (PADDING)
