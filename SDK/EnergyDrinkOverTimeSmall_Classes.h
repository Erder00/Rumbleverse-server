...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass EnergyDrinkOverTimeSmall.EnergyDrinkOverTimeSmall_C
	 * Size -> 0x0038 (FullSize[0x0738] - InheritedSize[0x0700])
	 */
	class AEnergyDrinkOverTimeSmall_C : public AIGHealthAndStaminaConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_13503701445FDA68BDF5608980273719; // 0x0710(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_13503701445FDA68BDF5608980273719; // 0x0714(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_13503701445FDA68BDF5608980273719; // 0x0718(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_4PQJ[0x7];                                   // 0x0719(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_EnergyDrinkOverTimeSmall(int32_t EntryPoint);
