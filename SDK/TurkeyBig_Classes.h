...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass TurkeyBig.TurkeyBig_C
	 * Size -> 0x0038 (FullSize[0x0738] - InheritedSize[0x0700])
	 */
	class ATurkeyBig_C : public AIGHealthAndStaminaConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_382A20D24B6E14E314CED9BE615C1EF1; // 0x0710(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_382A20D24B6E14E314CED9BE615C1EF1; // 0x0714(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_382A20D24B6E14E314CED9BE615C1EF1; // 0x0718(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_CO8H[0x7];                                   // 0x0719(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_TurkeyBig(int32_t EntryPoint);
