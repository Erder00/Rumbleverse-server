...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_CombatNotification_Comeback.WBP_CombatNotification_Comeback_C
	 * Size -> 0x0028 (FullSize[0x0440] - InheritedSize[0x0418])
	 */
	class UWBP_CombatNotification_Comeback_C : public UIGUI_WidgetBase
	{
	public:
	...
	public:
		void ShiftUp();
		void ShowComebackNotif();
		void ConstructOnlyOnce();
		void ExecuteUbergraph_WBP_CombatNotification_Comeback(int32_t EntryPoint);
