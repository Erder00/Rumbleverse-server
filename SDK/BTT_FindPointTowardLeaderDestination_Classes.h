...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BTT_FindPointTowardLeaderDestination.BTT_FindPointTowardLeaderDestination_C
	 * Size -> 0x0090 (FullSize[0x0138] - InheritedSize[0x00A8])
	 */
	class UBTT_FindPointTowardLeaderDestination_C : public UBTTask_BlueprintBase
	{
	public:
		...
		class FName                                                SearchDistanceDestinationParamName;                      // 0x0100(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class FName                                                SearchDistanceSelfParamName;                             // 0x0108(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		float                                                      SearchDistanceFromSelf;                                  // 0x0118(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      SearchDistanceFromDestination;                           // 0x011C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_BTT_FindPointTowardLeaderDestination(int32_t EntryPoint);
