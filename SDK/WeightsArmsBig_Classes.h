...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass WeightsArmsBig.WeightsArmsBig_C
	 * Size -> 0x0040 (FullSize[0x0700] - InheritedSize[0x06C0])
	 */
	class AWeightsArmsBig_C : public ASheikCoreStatsConsumable
	{
	public:
		...
		float                                                      Projectile_SFX_Oscillator_Timeline_Pitch_Multiplier_22255B0E41BC526EBA4E9CB1F866976F; // 0x06D8(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Projectile_SFX_Oscillator_Timeline_Volume_Multiplier_22255B0E41BC526EBA4E9CB1F866976F; // 0x06DC(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		ETimelineDirection                                         Projectile_SFX_Oscillator_Timeline__Direction_22255B0E41BC526EBA4E9CB1F866976F; // 0x06E0(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_OLD7[0x7];                                   // 0x06E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnUse();
		void ExecuteUbergraph_WeightsArmsBig(int32_t EntryPoint);
