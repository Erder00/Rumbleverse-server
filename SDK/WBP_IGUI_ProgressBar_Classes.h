...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_IGUI_ProgressBar.WBP_IGUI_ProgressBar_C
	 * Size -> 0x00FC (FullSize[0x0514] - InheritedSize[0x0418])
	 */
	class UWBP_IGUI_ProgressBar_C : public UIGUI_WidgetBase
	{
	public:
		...
		unsigned char                                              UnknownData_6ALI[0x3];                                   // 0x04D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0Q5T[0x3];                                   // 0x0505(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_WBP_IGUI_ProgressBar(int32_t EntryPoint);
