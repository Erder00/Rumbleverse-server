...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_CombatNotification_FullSuperstar.WBP_CombatNotification_FullSuperstar_C
	 * Size -> 0x0020 (FullSize[0x0438] - InheritedSize[0x0418])
	 */
	class UWBP_CombatNotification_FullSuperstar_C : public UIGUI_WidgetBase
	{
	public:
	...
	public:
		void ShiftUp();
		void ShowFullSuperstarNotif();
		void ConstructOnlyOnce();
		void ExecuteUbergraph_WBP_CombatNotification_FullSuperstar(int32_t EntryPoint);
