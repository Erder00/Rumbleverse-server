...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass WBP_Sheik_StatusSlot.WBP_Sheik_StatusSlot_C
	 * Size -> 0x0028 (FullSize[0x0440] - InheritedSize[0x0418])
	 */
	class UWBP_Sheik_StatusSlot_C : public UIGUI_WidgetBase
	{
	public:
		...
		class URichTextBlock*                                      Timer;                                                   // 0x0428(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		void GetPerkEffectTextureFromDataTable(const class FName& RowName, class UTexture2D** OutTexture);
		void UpdateTimer(int32_t InSeconds);
		void UpdateIcon(class UTexture2D* Texture);
		void Deactivate();
		void Activate(const struct FIGPerkHUDInfo& Info);
		void ConstructOnlyOnce();
		void ExecuteUbergraph_WBP_Sheik_StatusSlot(int32_t EntryPoint);
